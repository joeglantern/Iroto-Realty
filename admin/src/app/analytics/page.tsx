          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              ...
              <nav className="hidden md:flex space-x-8">
                ...
                <Link href="/analytics" className="px-3 py-2 text-sm font-medium text-primary bg-primary/10 rounded-md transition-colors">
                  Analytics
                </Link>
              </nav>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t bg-white">
            <div className="px-4 py-2 space-y-1">
              ...
              <Link href="/analytics" className="block w-full text-left px-3 py-2 text-sm font-medium text-primary bg-primary/10 rounded-md transition-colors">
                Analytics
              </Link>
            </div>
          </div>
