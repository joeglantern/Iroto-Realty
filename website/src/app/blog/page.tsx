  ...
  return (
    <PageLayout>
      <div>
        ...
        <section className="relative bg-gradient-to-br from-gray-50 via-white to-brown/5 border-b border-gray-100 overflow-hidden">
          {/* Subtle background pattern */}
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-0 left-0 w-72 h-72 bg-brown/10 rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-brown/5 rounded-full blur-3xl transform translate-x-1/3 translate-y-1/3"></div>
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center mb-10">
              ...
              <div className="flex items-center justify-center space-x-2 text-sm text-gray-500 mb-4">
                ...
                <span className="text-brown font-medium">Blog</span>
              </div>
              
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                Our <span className="text-brown relative">
                  Blog
                  <div className="absolute -bottom-1 left-0 w-full h-1 bg-brown/20 rounded-full"></div>
                </span>
              </h1>
              ...
              {/* Stats bar */}
              <div className="flex items-center justify-center flex-wrap gap-x-8 gap-y-3 mt-6 text-sm text-gray-500">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-6 shadow-sm">
              <div className="flex items-center justify-center mb-4">
                <svg className="w-5 h-5 text-brown mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      ...
                      className={`px-6 py-2.5 rounded-full font-medium transition-all duration-200 ${
                        selectedCategory === category
                          ? 'bg-brown text-white shadow-lg shadow-brown/25 transform scale-105'
                          : 'bg-white text-brown border border-brown/20 hover:bg-brown hover:text-white hover:border-brown hover:shadow-md hover:scale-105'
                      }`}
                    >
                      {category}
                    </button>
