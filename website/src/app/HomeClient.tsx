...
export default function Home() {
  ...
  const Intro = LAUNCH_CELEBRATION_ENABLED ? LaunchCelebration : LoadingScreen;

  // The page renders underneath the intro so it is in the HTML search engines receive.
  return (
    <>
    {shouldShowLoading && <Intro onComplete={handleLoadingComplete} />}
    <PageLayout>
      <div>
