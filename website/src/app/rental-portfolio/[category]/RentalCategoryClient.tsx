...
function PropertyCard({ id, images, title, location, price, slug, bedrooms, beds, listingType = 'rental' }: PropertyCardProps) {
...
export default function CategoryPage({ initialCategory, initialProperties }: CategoryPageProps = {}) {
  const params = useParams();
  const categorySlug = params.category as string;
  
  const [category, setCategory] = useState<PropertyCategory | null>(initialCategory ?? null);
      ...
      <div>
        ...
        <section className="relative h-[60vh] flex items-center justify-center">
          <div 
            ...
            style={{
              backgroundImage: `url("${category.hero_image_path ? getStorageUrl('property-images', category.hero_image_path) : 'https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80'}")`
            }}
          />
          ...
          <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl lg:text-2xl text-white/90 mb-8">
              Luxury rental properties in {category.name}
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-black mb-4">
                Available Properties in {category.name}
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Discover our exclusive collection of luxury rental properties in this beautiful destination.
              </p>
            </div>
              ...
              {properties.length === 0 ? (
                <div className="col-span-full text-center py-12">
                  ...
                  <p className="text-gray-500">
                    We don't have any properties in {category.name} at the moment. Please check back later or explore other destinations.
                  </p>
                </div>
              ) : (
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We also have access to a selected portfolio of off-market and partner properties that are not publicly advertised.
              Tell us what you're looking for, and we'll curate suitable options for you.
            </p>
